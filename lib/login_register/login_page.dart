          ...
          children: [
            Column(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(left: 18.w, top: 18.h, right: 19.w),
                  height: 26.h,
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Container(
                          margin: EdgeInsets.only(left: 15.w, bottom: 1.h),
                          height:11.h,
                          width: 101.w,
                          child: TextField(
                            controller: shoujihao,
                            cursorColor: ColorsUtil.hexColor(0xFD8C8C),
...
//                  textAlign: TextAlign.center,//文本对齐方式
                            ...
                            onChanged: (text) {
                              //内容改变的回调
                              print('change $text');
                              int length = shoujihao.text.length;
                              shoujihao.text = CommonUtil.splitPhoneNumber1(text);
                              shoujihao.selection = TextSelection.fromPosition(
                                  TextPosition(
                                      affinity: TextAffinity.downstream,
                                      offset: shoujihao.text.length));
                              // if (length == 3) {
                              //   shoujihao.text = (shoujihao.text + "  ").toString();
                              //   shoujihao.selection = TextSelection.fromPosition(
                              //       TextPosition(
                              //           affinity: TextAffinity.downstream,
                              //           offset: shoujihao.text.length));
...
//                  enabled: true,//是否禁用
                      ...
                      Offstage(
                          offstage:
                          shoujihao.text.toString().isEmpty ? true : false,
                          child: InkWell(
                            onTap: () {
                              shoujihao.clear();
                            },
...
//              margin: EdgeInsets.only(top: ScreenUtil().setWidth(50)),
                  margin: EdgeInsets.only(
                      ...
                      right: ScreenUtil().setWidth(18),bottom: 45.h),
                  ...
                  child: MaterialButton(
                    ...
                    color: ((shoujihao.text.length>0)&&(yazhengma.text.length>0)) ? ColorsUtil.hexColor(0xFD3D46) : ColorsUtil.hexColor(0xFD8C8C),
                    textColor: Colors.white,
