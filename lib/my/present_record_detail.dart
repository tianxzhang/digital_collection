...
class PresentRecordDetailPage extends StatefulWidget {
  final String id;

  PresentRecordDetailPage(this.id);

  @override
  PresentRecordDetailPageState createState() => PresentRecordDetailPageState();
}

class PresentRecordDetailPageState extends State<PresentRecordDetailPage>
    with AutomaticKeepAliveClientMixin {
  var resultData;
  PresentDetailEntity presentDetailEntity = PresentDetailEntity();
  ...
  Future getData() async {
    ...
    var result = await NetWorkUtil.getHttpQuery("/n/transfer/orderInfo", postMap);
    Map<String, dynamic> resultMap = json.decode(result.toString());
    if (resultMap["code"] == 1) {
      presentDetailEntity = PresentDetailEntity.fromJson(resultMap);
      return;
    }
  }
                            ...
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                errorWidget:
                                    (context, url, error) =>
                                    Icon(Icons.error),
                                imageUrl: presentDetailEntity.data?.productPhoto??"",
                              ),
                            ),
                                ...
                                children: [
                                  Container(
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          child: Text(presentDetailEntity.data?.productName??"",
                                              style: TextStyle(
                                                  color: ColorsUtil.hexColor(0xffffff),
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.bold)),
                                  ...
                                  Container(
                                    child: Text(presentDetailEntity.data?.toPhone??"",
                                        style: TextStyle(
                                  ...
                                  Container(
                                    child: Text("${presentDetailEntity.data?.productPrice??""}${presentDetailEntity.data?.productUnit??""}",
                                        style: TextStyle(
                                            color: ColorsUtil.hexColor(0xffffff),
                                            fontSize: 18.sp,
                                            fontWeight: FontWeight.bold)),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                                "${presentDetailEntity.data?.productPrice??""}${presentDetailEntity.data?.productUnit??""}",
                                style: TextStyle(
                                    fontSize: 14.sp,
                                    color: ColorsUtil.hexColor(0xB5B5B5),
                                    fontWeight: FontWeight.bold)),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                                "${presentDetailEntity.data?.orderId}",
                                style: TextStyle(
                                    fontSize: 14.sp,
                                    color: ColorsUtil.hexColor(0xB5B5B5),
                                    fontWeight: FontWeight.bold)),
